...
*/
      ...
      var ctls = angular.module(name, []).controller('MainCtrl', require('./main-controller')).controller('HomeCtrl', require('./home-controller'));
    },
    {
      './home-controller': 2,
      './main-controller': 3
...
*/
      ...
      var services = angular.module(name, []).factory('Blogs', require('./blog-service'));
    },
    { './blog-service': 5 }
  ],
  5: [
...
*/
    ...
    {
      './angular-animate.min': 8,
      './angular-resource.min': 9,
      './angular-route.min': 10,
      './angular-touch.min': 11,
      './angular.min': 12
    }
  ],
  8: [
...
*/
      (function (v, k, t) {
        'use strict';
        k.module('ngAnimate', ['ng']).factory('$$animateReflow', [
          '$window',
          '$timeout',
          function (k, B) {
            var d = k.requestAnimationFrame || k.webkitRequestAnimationFrame || function (d) {
                return B(d, 10, !1);
              }, q = k.cancelAnimationFrame || k.webkitCancelAnimationFrame || function (d) {
                return B.cancel(d);
              };
            return function (p) {
              var k = d(p);
          ...
          function (R, B) {
            ...
            var q = k.noop, p = k.forEach, $ = B.$$selectors, X = 1, l = '$$ngAnimateState', K = 'ng-animate', m = { running: !0 };
            R.decorator('$animate', [
              '$delegate',
              '$injector',
              '$sniffer',
              ...
              '$rootScope',
              '$document',
              function (C, v, t, H, y, w, N) {
                function I(a) {
                  if (a) {
                    var g = [], e = {};
                    a = a.substr(1).split('.');
                    (t.transitions || t.animations) && a.push('');
                    for (var c = 0; c < a.length; c++) {
                      var f = a[c], d = $[f];
                      d && !e[f] && (g.push(v.get(d)), e[f] = !0);
                    }
                    return g;
                  }
                }
                function r(a, g, e, c, f, k, m) {
                  function t(a) {
                    n();
                    if (!0 === a)
                      z();
                  ...
                  function C(c, d, f) {
                    ...
                    p(c, function (b, aa) {
                      ...
                      'before' != d || 'enter' != a && 'move' != a ? b[d] ? b[k] = u ? b[d](e, g, h) : b[d](e, h) : h() : h();
                    });
                  }
                  function w(c) {
                    e.triggerHandler('$animate:' + c, {
                      event: a,
                      className: g
                    });
                  }
                  ...
                  function n() {
                    n.hasBeenRun || (n.hasBeenRun = !0, k());
                  }
                  function z() {
                    if (!z.hasBeenRun) {
                      z.hasBeenRun = !0;
                      var a = e.data(l);
                      a && (u ? A(e) : (a.closeAnimationTimeout = y(function () {
                        A(e);
                      }, 0, !1), e.data(l, a)));
                      v();
                    }
                  ...
                  var s, x, G = d(e);
                  G && (s = G.className, x = s + ' ' + g);
                  if (G && L(x)) {
                    x = (' ' + x).replace(/\s+/g, '.');
                    c || (c = f ? f.parent() : e.parent());
                    x = I(x);
                    var u = 'addClass' == a || 'removeClass' == a;
                    f = e.data(l) || {};
                    if (ba(e, c) || 0 === x.length)
                      n(), E(), r(), z();
                    else {
                      var D = [];
                      u && (f.disabled || f.running && f.structural) || p(x, function (c) {
                        if (!c.allowCancel || c.allowCancel(e, a, g)) {
                          var d = c[a];
                          'leave' == a ? (c = d, d = null) : c = c['before' + a.charAt(0).toUpperCase() + a.substr(1)];
                          D.push({
                            before: c,
                            after: d
                          });
                      ...
                      0 === D.length ? (n(), E(), r(), v()) : (c = ' ' + s + ' ', f.running && (y.cancel(f.closeAnimationTimeout), A(e), J(f.animations), x = (s = u && !f.structural) && f.className == g && a != f.event, f.beforeComplete || x ? (f.done || q)(!0) : s && (c = 'removeClass' == f.event ? c.replace(' ' + f.className + ' ', ' ') : c + f.className + ' ')), s = ' ' + g + ' ', 'addClass' == a && 0 <= c.indexOf(s) || 'removeClass' == a && -1 == c.indexOf(s) ? (n(), E(), r(), v()) : (e.addClass(K), e.data(l, {
                        running: !0,
                        event: a,
                        className: g,
                        structural: !u,
                ...
                function Q(a) {
                  a = d(a);
                  p(a.querySelectorAll('.' + K), function (a) {
                    a = k.element(a);
                    var e = a.data(l);
                    e && (J(e.animations), A(a));
                  });
                }
                function J(a) {
                  p(a, function (a) {
                    a.beforeComplete || (a.beforeEnd || q)(!0);
                    a.afterComplete || (a.afterEnd || q)(!0);
                  });
                }
                function A(a) {
                  d(a) == d(H) ? m.disabled || (m.running = !1, m.structural = !1) : (a.removeClass(K), a.removeData(l));
                }
                function ba(a, g) {
                  if (m.disabled)
                    return !0;
                  if (d(a) == d(H))
                    return m.disabled || m.running;
                  do {
                    if (0 === g.length)
                      break;
                    var e = d(g) == d(H), c = e ? m : g.data(l), c = c && (!!c.disabled || !!c.running);
                    if (e || c)
                      return c;
                    if (e)
                      break;
                ...
                var M = B.classNameFilter(), L = M ? function (a) {
                    return M.test(a);
                  } : function () {
                    return !0;
                  };
                return {
                  enter: function (a, d, e, c) {
                    this.enabled(!1, a);
                    C.enter(a, d, e);
                    w.$$postDigest(function () {
                      r('enter', 'ng-enter', a, d, e, q, c);
                    });
                  },
                  leave: function (a, d) {
                    Q(a);
                  ...
                  move: function (a, d, e, c) {
                    Q(a);
                    this.enabled(!1, a);
                    C.move(a, d, e);
                    w.$$postDigest(function () {
                      r('move', 'ng-move', a, d, e, q, c);
                    });
                  },
            ...
            B.register('', [
              ...
              function (m, l, B, H) {
                function y(b, a) {
                  ...
                  b = k.element(h);
                  V.push(b);
                  var h = b.data(n), c = h.stagger, c = h.itemIndex * (Math.max(c.animationDelay, c.transitionDelay) || 0);
                  P = Math.max(P, (c + (h.maxDelay + h.maxDuration) * s) * x);
                  h.animationCount = G;
                  O = H(function () {
                    p(U, function (b) {
                      b();
                ...
                function w(b, a) {
                  p(b, function (b) {
                    (b = b.data(n)) && b.animationCount == a && (b.closeAnimationFn || q)();
                  });
                }
                function N(b, a) {
                  var h = a ? u[a] : null;
                  if (!h) {
                    var d = 0, c = 0, e = 0, k = 0, g, n, l, r;
                    p(b, function (b) {
                      if (b.nodeType == X) {
                        b = m.getComputedStyle(b) || {};
                        l = b[f + Y];
                        d = Math.max(I(l), d);
                        r = b[f + W];
                        g = b[f + E];
                ...
                function I(b) {
                  var a = 0;
                  b = k.isString(b) ? b.split(/\s*,\s*/) : [];
                  p(b, function (b) {
                    a = Math.max(parseFloat(b) || 0, a);
                  });
                  return a;
                }
                function r(b) {
                  var a = b.parent(), h = a.data(Z);
                  h || (a.data(Z, ++D), h = D);
                  return h + '-' + d(b).className;
                }
                function Q(b, a, h) {
                  var c = r(b), e = c + ' ' + a, k = {}, g = u[e] ? ++u[e].total : 0;
                  if (0 < g) {
                    var l = a + '-stagger', k = c + ' ' + l;
                    (c = !u[k]) && b.addClass(l);
                    k = N(b, k);
                    c && b.removeClass(l);
                  }
                  ...
                  l = Math.max(h.transitionDelay, h.animationDelay);
                  c = Math.max(h.transitionDuration, h.animationDuration);
                  if (0 === c)
                    return b.removeClass(a), !1;
                  var m = '';
                  0 < h.transitionDuration ? d(b).style[f + W] = 'none' : d(b).style[F] = 'none 0s';
                  p(a.split(' '), function (b, a) {
                    m += (0 < a ? ' ' : '') + b + '-active';
                  });
                  b.data(n, {
                    className: a,
                ...
                function K(b, a, h) {
                  function e(c) {
                    ...
                    c = d(b);
                    for (var h in s)
                      c.style.removeProperty(s[h]);
                  }
                  function k(b) {
                    b.stopPropagation();
                    var a = b.originalEvent || b;
                    b = a.$manualTimeStamp || a.timeStamp || Date.now();
                    a = parseFloat(a.elapsedTime.toFixed(z));
                    Math.max(b - w, 0) >= u && a >= p && h();
                  }
                  var f = b.data(n), g = d(b);
                  if (-1 != g.className.indexOf(a) && f) {
                    var l = f.timings, m = f.stagger, p = f.maxDuration, r = f.activeClassName, u = Math.max(l.transitionDelay, l.animationDelay) * x, w = Date.now(), v = T + ' ' + S, t = f.itemIndex, q = '', s = [];
                    if (0 < l.transitionDuration) {
                      var y = l.transitionPropertyStyle;
                      -1 == y.indexOf('all') && (q += c + 'transition-property: ' + y + ';', q += c + 'transition-duration: ' + l.transitionDurationStyle + ';', s.push(c + 'transition-property'), s.push(c + 'transition-duration'));
                    }
                    0 < t && (0 < m.transitionDelay && 0 === m.transitionDuration && (q += c + 'transition-delay: ' + M(l.transitionDelayStyle, m.transitionDelay, t) + '; ', s.push(c + 'transition-delay')), 0 < m.animationDelay && 0 === m.animationDuration && (q += c + 'animation-delay: ' + M(l.animationDelayStyle, m.animationDelay, t) + '; ', s.push(c + 'animation-delay')));
                    0 < s.length && (l = g.getAttribute('style') || '', g.setAttribute('style', l + ' ' + q));
                    b.on(v, k);
                    b.addClass(r);
                    f.closeAnimationFn = function () {
                      e();
                      h();
                    };
                    return e;
                ...
                function L(b, a, c) {
                  if (Q(b, a, c))
                    return function (c) {
                      c && (b.removeClass(a), b.removeData(n));
                    };
                }
                function a(a, c, d) {
                  if (a.data(n))
                ...
                function e(a, c) {
                  ...
                  p(a, function (a, b) {
                    a && 0 < a.length && (d += (0 < b ? ' ' : '') + a + c);
                  });
                  return d;
                }
                var c = '', f, S, F, T;
                v.ontransitionend === t && v.onwebkittransitionend !== t ? (c = '-webkit-', f = 'WebkitTransition', S = 'webkitTransitionEnd transitionend') : (f = 'transition', S = 'transitionend');
                v.onanimationend === t && v.onwebkitanimationend !== t ? (c = '-webkit-', F = 'WebkitAnimation', T = 'webkitAnimationEnd animationend') : (F = 'animation', T = 'animationend');
                var Y = 'Duration', W = 'Property', E = 'Delay', R = 'IterationCount', Z = '$$ngAnimateKey', n = '$$ngAnimateCSS3Data', z = 3, s = 1.5, x = 1000, G = 0, u = {}, D = 0, U = [], V = [], O, P = 0;
                return {
                  allowCancel: function (a, c, h) {
                    var f = (a.data(n) || {}).classes;
                    if (!f || 0 <= [
                        'enter',
                        'leave',
                        'move'
                      ...
                      return !0;
                    var l = a.parent(), g = k.element(d(a).cloneNode());
                    g.attr('style', 'position:absolute; top:-9999px; left:-9999px');
                    g.removeAttr('id');
                    g.empty();
                    p(f.split(' '), function (a) {
                      g.removeClass(a);
                    });
                    g.addClass(e(h, 'addClass' == c ? '-add' : '-remove'));
                    l.append(g);
                    a = N(g);
                    g.remove();
                  ...
                  enter: function (a, c) {
                    return g(a, 'ng-enter', c);
                  },
                  leave: function (a, c) {
                    return g(a, 'ng-leave', c);
                  },
                  move: function (a, c) {
                    return g(a, 'ng-move', c);
                  },
                  beforeAddClass: function (a, c, d) {
                    var f = L(a, e(c, '-add'), function (d) {
                        a.addClass(c);
                        d = d();
                        a.removeClass(c);
                        return d;
                  ...
                  beforeRemoveClass: function (a, c, d) {
                    var f = L(a, e(c, '-remove'), function (d) {
                        var e = a.attr('class');
                        a.removeClass(c);
                        d = d();
                        a.attr('class', e);
      ...
      }(window, window.angular));  //# sourceMappingURL=angular-animate.min.js.map
    },
    {}
  ],
  9: [
            ...
            function (a, c, b, f, n, q, v, l) {
              function g() {
                ...
                if (d && m && d.$$route === m.$$route && e.equals(d.pathParams, m.pathParams) && !d.reloadOnSearch && !x)
                  ...
                  x = !1, a.$broadcast('$routeChangeStart', d, m), (r.current = d) && d.redirectTo && (e.isString(d.redirectTo) ? c.path(u(d.redirectTo, d.params)).search(d.params).replace() : c.url(d.redirectTo(d.pathParams, c.path(), c.search())).replace()), f.when(d).then(function () {
                    if (d) {
              ...
              bind: function (a, b) {
                ...
                a.on('touchmove mousemove', function (a) {
                  if (d && r) {
                    ...
                    n += Math.abs(m.y - h.y);
                    h = m;
                    10 > l && 10 > n || (n > l ? (d = !1, b.cancel && b.cancel(a)) : (a.preventDefault(), b.move && b.move(m, a)));
                  }
                });
...
*/
      (function (P, R, s) {
        ...
        function Ka(b) {
          return '[object Date]' === La.call(b);
        }
        function L(b) {
          return '[object Array]' === La.call(b);
        }
        function M(b) {
          return 'function' === typeof b;
        }
        function $a(b) {
          return '[object RegExp]' === La.call(b);
        }
        function za(b) {
        ...
        function $(b, a) {
          ...
          if (a) {
            ...
            (a = b) && (L(b) ? a = $(b, []) : Ka(b) ? a = new Date(b.getTime()) : $a(b) ? a = RegExp(b.source) : W(b) && (a = $(b, {})));
          return a;
        }
        function Rb(b, a) {
          a = a || {};
        ...
        function ta(b, a) {
          ...
          if (c == typeof a && 'object' == c)
            if (L(b)) {
              ...
              if (Ka(b))
                return Ka(a) && b.getTime() == a.getTime();
              if ($a(b) && $a(a))
                return b.toString() == a.toString();
              if (b && b.$evalAsync && b.$watch || a && a.$evalAsync && a.$watch || za(b) || za(a) || L(a))
                return !1;
              c = {};
              for (d in b)
                if ('$' !== d.charAt(0) && !M(b[d])) {
              ...
              for (d in a)
                if (!c.hasOwnProperty(d) && '$' !== d.charAt(0) && a[d] !== s && !M(a[d]))
                  return !1;
              return !0;
            }
          return !1;
        ...
        function Rc(b, a) {
          var c = a;
          'string' === typeof b && '$' === b.charAt(0) ? c = s : za(a) ? c = '$WINDOW' : a && R === a ? c = '$DOCUMENT' : a && (a.$evalAsync && a.$watch) && (c = '$SCOPE');
          return c;
        }
        function pa(b, a) {
          return 'undefined' === typeof b ? s : JSON.stringify(b, Rc, a ? '  ' : null);
        }
        function Tb(b) {
        ...
        function Vb(b) {
          ...
          q((b || '').split('&'), function (b) {
            b && (c = b.split('='), d = Ub(c[0]), D(d) && (b = D(c[1]) ? Ub(c[1]) : !0, a[d] ? L(a[d]) ? a[d].push(b) : a[d] = [
              a[d],
              b
            ] : a[d] = b));
          });
        ...
        function Pa(b, a, c) {
          ...
          tb(M(b), a, 'not a function, got ' + (b && 'object' == typeof b ? b.constructor.name || 'Object' : typeof b));
          return b;
        }
        function wa(b, a) {
          if ('hasOwnProperty' === b)
            ...
            if (!d || null != b)
              for (; e.length;)
                for (k = e.shift(), l = 0, n = k.length; l < n; l++)
                  for (p = z(k[l]), m ? p.triggerHandler('$destroy') : m = !m, r = 0, p = (F = p.children()).length; r < p; r++)
                    e.push(Ca(F[r]));
        ...
        function ac(b, a, c, d) {
          ...
          ja(b, 'handle') && (u(a) ? q(e, function (a, c) {
            ...
            u(c) ? (zb(b, a, e[a]), delete e[a]) : Ma(e[a] || [], c);
          }));
        }
        function $b(b, a) {
          var c = b[db], d = Ra[c];
        ...
        function Ea(b) {
          var a = typeof b, c;
          'object' == a && null !== b ? 'function' == typeof (c = b.$$hashKey) ? c = b.$$hashKey() : c === s && (c = b.$$hashKey = Za()) : c = b;
          return a + ':' + c;
        }
        function Sa(b) {
          q(b, this.put, this);
        ...
        function gc(b) {
          ...
          })), b.$inject = a) : L(b) ? (c = b.length - 1, Pa(b[c], 'fn'), a = b.slice(0, c)) : Pa(b, 'fn', !0);
          return a;
        }
        function Yb(b) {
          function a(a) {
              ...
              if (!k.get(a)) {
                ...
                try {
                  if (w(a))
                    ...
                    M(a) ? b.push(n.invoke(a)) : L(a) ? b.push(n.invoke(a)) : Pa(a, 'module');
                } catch (r) {
                  throw L(a) && (a = a[a.length - 1]), r.message && (r.stack && -1 == r.stack.indexOf(r.message)) && (r = r.message + '\n' + r.stack), Ta('modulerr', a, r.stack || r.message || r);
                }
              }
            });
            return b;
        ...
        function dd(b, a, c, d) {
          ...
          function f() {
            C = null;
            Q != h.url() && (Q = h.url(), q(ka, function (a) {
              a(h.url());
            }));
          }
          ...
          h.url = function (a, c) {
            ...
            if (a) {
              if (Q != a)
                return Q = a, d.history ? c ? l.replaceState(null, '', a) : (l.pushState(null, '', a), K.attr('href', K.attr('href'))) : (C = a, c ? k.replace(a) : k.href = a), h;
            } else
              return C || k.href.replace(/%27/g, '\'');
          };
          var ka = [], I = !1;
          ...
          h.cookies = function (a, b) {
            var d, e, g, h;
            if (a)
              b === s ? m.cookie = escape(a) + '=;path=' + aa + ';expires=Thu, 01 Jan 1970 00:00:00 GMT' : w(b) && (d = (m.cookie = escape(a) + '=' + escape(b) + ';path=' + aa).length + 1, 4096 < d && c.warn('Cookie \'' + a + '\' possibly not set or overflowed because it was too large (' + d + ' > 4096 bytes)!'));
            else {
              if (m.cookie !== ba)
                for (ba = m.cookie, d = ba.split('; '), U = {}, g = 0; g < d.length; g++)
                  e = d[g], h = e.indexOf('='), 0 < h && (a = unescape(e.substring(0, h)), U[a] === s && (U[a] = unescape(e.substring(h + 1))));
              return U;
            }
          };
          ...
          h.defer.cancel = function (a) {
            return r[a] ? (delete r[a], p(a), e(E), !0) : !1;
          };
        }
        function ed() {
          this.$get = [
        ...
        function ic(b, a) {
          ...
          this.directive = function m(a, e) {
            wa(a, 'directive');
            w(a) ? (tb(e, 'directiveFactory'), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, [
              '$injector',
              '$exceptionHandler',
              function (b, d) {
                var e = [];
                q(c[a], function (c, g) {
                  try {
                    var f = b.invoke(c);
                    M(f) ? f = { compile: Y(f) } : !f.compile && f.link && (f.compile = Y(f.link));
          ...
          this.$get = [
            ...
            '$animate',
            '$$sanitizeUri',
            function (a, b, l, n, p, r, F, A, H, v, Q, K) {
              ...
              function I(a, b, c, d, e, g) {
                function f(a, c, d, e) {
                  ...
                  for (n = 0; n < g; n++)
                    F[n] = c[n];
                  J = n = 0;
                  for (p = m.length; n < p; J++)
                    k = F[J], c = m[n++], g = m[n++], r = z(k), c ? (c.scope ? (l = a.$new(), r.data('$scope', l)) : l = a, (r = c.transclude) || !e && b ? c(g, l, k, d, U(a, r || b)) : c(g, l, k, d, e)) : g && g(a, k.childNodes, s, e);
                }
                for (var m = [], k, r, l, n, p = 0; p < a.length; p++)
                  k = new Db(), r = ba(a[p], [], k, 0 === p ? d : s, e), (g = r.length ? ga(r, a[p], k, b, c, null, [], [], g) : null) && g.scope && ka(z(a[p]), 'ng-scope'), k = g && g.terminal || !(l = a[p].childNodes) || !l.length ? null : I(l, g ? g.transclude : b), m.push(g, k), n = n || g || k, g = null;
                return n ? f : null;
              }
              function U(a, b) {
              ...
              function ba(a, b, c, d, f) {
                ...
                case 1:
                  ...
                  var r, l, n;
                  k = a.attributes;
                  for (var p = 0, F = k && k.length; p < F; p++) {
                    var A = !1, Q = !1;
                    r = k[p];
                  ...
                  if (w(a) && '' !== a)
                    for (; k = g.exec(a);)
                      n = la(k[2]), S(b, n, 'C', d, f) && (c[n] = Z(k[3])), a = a.substr(k.index + k[0].length);
                  break;
                case 3:
                  t(b, a.nodeValue);
                  break;
                case 8:
                  try {
                    if (k = e.exec(a.nodeValue))
                      n = la(k[1]), S(b, n, 'M', d, f) && (c[n] = Z(k[2]));
                  } catch (H) {
                  }
                }
                b.sort(u);
              ...
              function ga(a, c, d, e, g, f, m, n, p) {
                ...
                function H(a, e, g, f, p) {
                  ...
                  f = 0;
                  for (v = m.length; f < v; f++)
                    try {
                      I = m[f], I(I.isolateScope ? B : e, C, J, I.require && Q(I.require, C, aa), gb);
                    } catch (S) {
                      l(S, fa(C));
                    }
                  f = e;
                  ...
                  for (f = n.length - 1; 0 <= f; f--)
                    try {
                      I = n[f], I(I.isolateScope ? B : e, C, J, I.require && Q(I.require, C, aa), gb);
                    } catch (G) {
                      l(G, fa(C));
                    }
                }
                p = p || {};
                var v = -Number.MAX_VALUE, I, U = p.controllerDirectives, K = p.newIsolateScopeDirective, ga = p.templateDirective;
                ...
                for (var S = !1, u = !1, y = d.$$element = z(c), G, ca, t, P = e, O, N = 0, ma = a.length; N < ma; N++) {
                  ...
                  if (v > G.priority)
                    break;
                  if (t = G.scope)
                    I = I || G, G.templateUrl || (x('new/isolated scope', K, G, y), W(t) && (K = G));
                  ca = G.name;
                  !G.templateUrl && G.controller && (t = G.controller, U = U || {}, x('\'' + ca + '\' controller', U[ca], G, y), U[ca] = G);
                  if (t = G.transclude)
                    S = !0, G.$$tlb || (x('transclusion', p, G, y), p = G), 'element' == t ? (u = !0, v = G.priority, t = aa(c, Va, T), y = d.$$element = z(R.createComment(' ' + ca + ': ' + d[ca] + ' ')), c = y[0], hb(g, z(ua.call(t, 0)), c), P = C(t, e, v, f && f.name, { nonTlbTranscludeDirective: p })) : (t = z(yb(c)).contents(), y.empty(), P = C(t, e));
                  if (G.template)
                    if (x('template', ga, G, y), ga = G, t = M(G.template) ? G.template(y, d) : G.template, t = V(t), G.replace) {
                      f = G;
                      ...
                      y.html(t);
                  if (G.templateUrl)
                    x('template', ga, G, y), ga = G, G.replace && (f = G), H = E(a.splice(N, a.length - N), y, d, g, P, m, n, {
                    ...
                    try {
                      O = G.compile(y, d, P), M(O) ? A(null, O, Va, T) : O && A(O.pre, O.post, Va, T);
                    } catch (Y) {
                      l(Y, fa(y));
                    }
              ...
              function S(b, e, g, f, k, r, n) {
                ...
                if (c.hasOwnProperty(e)) {
                  ...
                  for (var F = 0, A = e.length; F < A; F++)
                    try {
                      p = e[F], (f === s || f > p.priority) && -1 != p.restrict.indexOf(g) && (r && (p = Qb(p, {
                        $$start: r,
                        $$end: n
                      })), b.push(p), k = p);
                    } catch (Q) {
              ...
              function D(a, b) {
                ...
                q(b, function (b, g) {
                  'class' == g ? (ka(e, b), a['class'] = (a['class'] ? a['class'] + ' ' : '') + b) : 'style' == g ? (e.attr('style', e.attr('style') + ';' + b), a.style = (a.style ? a.style + ';' : '') + b) : '$' == g.charAt(0) || a.hasOwnProperty(g) || (a[g] = b, d[g] = c[g]);
                });
              }
              function E(a, b, c, d, e, g, f, k) {
                var m = [], r, l, F = b[0], A = a.shift(), Q = y({}, A, {
                    templateUrl: null,
                    transclude: null,
                    replace: null,
                    $$originalDirective: A
                  }), C = M(A.templateUrl) ? A.templateUrl(b, c) : A.templateUrl;
                b.empty();
                n.get(v.getTrustedResourceUrl(C), { cache: p }).success(function (n) {
                  var p, H;
                  n = V(n);
                  if (A.replace) {
                    n = z('<div>' + Z(n) + '</div>').contents();
                    p = n[0];
                    if (1 != n.length || 1 !== p.nodeType)
                      throw ha('tplrt', A.name, C);
                    n = { $attr: {} };
                    hb(d, b, p);
                    var v = ba(p, [], n);
                    W(A.scope) && hc(v);
                ...
                return function (a, b, c, d, e) {
                  m ? (m.push(b), m.push(c), m.push(d), m.push(e)) : r(l, b, c, d, e);
                };
              }
              function u(a, b) {
              ...
              function x(a, b, c, d) {
                if (b)
                  throw ha('multidir', b.name, c.name, a, fa(d));
              }
              function t(a, c) {
                var d = b(c, !0);
                d && a.push({
              ...
              function hb(a, b, c) {
                ...
                for (e = b.length; d < e; d++)
                  g = b[d], z(g).remove(), a.appendChild(g), delete b[d];
                b[0] = c;
                b.length = 1;
              }
              function jc(a, b) {
              ...
              var ca = b.startSymbol(), ma = b.endSymbol(), V = '{{' == ca || '}}' == ma ? Aa : function (a) {
                  return a.replace(/\{\{/g, ca).replace(/}}/g, ma);
                }, T = /^ngAttr[A-Z]/;
              return C;
            }
          ];
        ...
        function id() {
          ...
          this.$get = [
            ...
            function (c, d) {
              return function (e, g) {
                var f, h, m;
                w(e) && (f = e.match(a), h = f[1], m = f[3], e = b.hasOwnProperty(h) ? b[h] : Zb(g.$scope, h, !0) || Zb(d, h, !0), Pa(e, h, !0));
                f = c.instantiate(e, g);
                if (m) {
                  if (!g || 'object' != typeof g.$scope)
                    throw t('$controller')('noscp', h || e.name, m);
                  g.$scope[m] = f;
                }
                return f;
              };
        ...
        function ld() {
          var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = { 'Content-Type': 'application/json;charset=utf-8' }, e = this.defaults = {
              ...
              transformRequest: [function (a) {
                  return W(a) && '[object File]' !== La.call(a) ? pa(a) : a;
                }],
              headers: {
          ...
          this.$get = [
            ...
            function (a, b, c, d, n, p) {
              ...
              function F(b, c, g) {
                ...
                F.then(k, k);
                (b.cache || e.cache) && (!1 !== b.cache && 'GET' == b.method) && (v = W(b.cache) ? b.cache : W(e.cache) ? e.cache : H);
                if (v)
                  if (q = v.get(s), D(q)) {
                    if (q.then)
                      return q.then(k, k), q;
        ...
        function md(b) {
          if (8 >= N && (!b.match(/^(get|post|head|put|delete|options)$/i) || !P.XMLHttpRequest))
        ...
        function nd() {
          this.$get = [
            ...
            '$document',
            function (b, a, c) {
              return od(b, md, b.defer, a.angular.callbacks, c[0]);
            }
          ];
        }
        function od(b, a, c, d, e) {
          function g(a, b) {
            ...
            c.src = a;
            N && 8 >= N ? c.onreadystatechange = function () {
        ...
        function pd() {
          ...
          this.$get = [
            ...
            function (c, d, e) {
              function g(g, k, l) {
                for (var n, p, r = 0, F = [], A = g.length, H = !1, v = []; r < A;)
                  -1 != (n = g.indexOf(b, r)) && -1 != (p = g.indexOf(a, n + f)) ? (r != n && F.push(g.substring(r, n)), F.push(r = c(H = g.substring(n + f, p))), r.exp = H, r = p + h, H = !0) : (r != A && F.push(g.substring(r)), r = A);
                (A = F.length) || (F.push(''), A = 1);
                if (l && 1 < F.length)
                  throw oc('noconcat', g);
                if (!k || H)
                  return v.length = A, r = function (a) {
                    try {
                      for (var b = 0, c = A, f; b < c; b++)
                        'function' == typeof (f = F[b]) && (f = f(a), f = l ? e.getTrusted(l, f) : e.valueOf(f), null === f || u(f) ? f = '' : 'string' != typeof f && (f = pa(f))), v[b] = f;
                      return v.join('');
                    } catch (k) {
                      a = oc('interr', g, k.toString()), d(a);
                    }
                  }, r.exp = g, r.parts = F, r;
              }
            ...
            function (c, d, e, g) {
              ...
              g.on('click', function (a) {
                if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                  for (var b = z(a.target); 'a' !== x(b[0].nodeName);)
                    if (b[0] === g[0] || !(b = b.parent())[0])
                      return;
                  var e = b.prop('href');
                  W(e) && '[object SVGAnimatedString]' === e.toString() && (e = xa(e.animVal).href);
                  var f = h.$$rewrite(e);
                  e && (!b.attr('target') && f && !a.isDefaultPrevented()) && (a.preventDefault(), f != d.url() && (h.$$parse(f), c.$apply(), P.angular['ff-684208-preventDefault'] = !0));
                }
              });
        ...
        function vc(b, a, c, d, e, g, f) {
          ...
          return f.unwrapPromises ? function (f, m) {
            ...
            if (null == k)
              return k;
            (k = k[b]) && k.then && (qa(g), '$$v' in k || (l = k, l.$$v = s, l.then(function (a) {
              l.$$v = a;
            })), k = k.$$v);
            if (!a)
              return k;
            if (null == k)
              return s;
            (k = k[a]) && k.then && (qa(g), '$$v' in k || (l = k, l.$$v = s, l.then(function (a) {
              l.$$v = a;
            })), k = k.$$v);
            if (!c)
              return k;
            if (null == k)
              return s;
            (k = k[c]) && k.then && (qa(g), '$$v' in k || (l = k, l.$$v = s, l.then(function (a) {
              l.$$v = a;
            })), k = k.$$v);
            if (!d)
              return k;
            if (null == k)
              return s;
            (k = k[d]) && k.then && (qa(g), '$$v' in k || (l = k, l.$$v = s, l.then(function (a) {
              l.$$v = a;
            })), k = k.$$v);
            if (!e)
              return k;
            if (null == k)
              return s;
            (k = k[e]) && k.then && (qa(g), '$$v' in k || (l = k, l.$$v = s, l.then(function (a) {
              l.$$v = a;
            })), k = k.$$v);
            return k;
          } : function (g, f) {
        ...
        function wc(b, a, c) {
          ...
          if (a.unwrapPromises || 1 !== e)
            if (a.unwrapPromises || 2 !== e)
              if (a.csp)
                g = 6 > e ? vc(d[0], d[1], d[2], d[3], d[4], c, a) : function (b, g) {
                  var f = 0, h;
                  do
                    h = vc(d[f++], d[f++], d[f++], d[f++], d[f++], c, a)(b, g), g = s, b = h;
                  while (f < e);
                  return h;
                };
              else {
        ...
        function xd() {
          ...
          this.logPromiseWarnings = function (b) {
            return D(b) ? (a.logPromiseWarnings = b, this) : a.logPromiseWarnings;
          };
          this.$get = [
            '$filter',
            '$sniffer',
            ...
            function (c, d, e) {
              a.csp = d.csp;
              qa = function (b) {
                a.logPromiseWarnings && !xc.hasOwnProperty(b) && (xc[b] = !0, e.warn('[$parse] Promise found in the expression `' + b + '`. Automatic unwrapping of promises in Angular expressions is deprecated.'));
              };
              return function (d) {
                var e;
                switch (typeof d) {
        ...
        function zd(b, a) {
                ...
                promise: {
                  ...
                  'finally': function (a) {
                    ...
                    function d(e, g) {
                      ...
                      return f && M(f.then) ? f.then(function () {
                        return b(e, g);
                      }, function (a) {
                        return b(a, !1);
                      }) : b(e, g);
          ...
          return {
            ...
            when: function (h, k, l, n) {
              ...
              b(function () {
                g(h).then(function (a) {
                  r || (r = !0, p.resolve(g(a).then(F, A, q)));
                }, function (a) {
                  r || (r = !0, p.resolve(A(a)));
                }, function (a) {
                  r || p.notify(q(a));
              ...
              h.prototype = {
                ...
                $watchCollection: function (a, b) {
                  ...
                  return this.$watch(function () {
                    ...
                    if (W(e))
                      if (qb(e))
                        for (d !== k && (d = k, l = d.length = 0, f++), a = e.length, l !== a && (f++, d.length = l = a), b = 0; b < a; b++)
                          d[b] !== e[b] && (f++, d[b] = e[b]);
                      else {
                        d !== m && (d = m = {}, l = 0, f++);
                        a = 0;
                      ...
                      do {
                        if (h = I.$$watchers)
                          for (q = h.length; q--;)
                            try {
                              if (d = h[q])
                                if ((f = d.get(I)) !== (g = d.last) && !(d.eq ? ta(f, g) : 'number' == typeof f && 'number' == typeof g && isNaN(f) && isNaN(g)))
                                  C = !0, c = d, d.last = d.eq ? $(f) : f, d.fn(f, g === n ? f : g, I), 5 > s && (t = 4 - s, U[t] || (U[t] = []), z = M(d.exp) ? 'fn: ' + (d.exp.name || d.exp.toString()) : d.exp, z += '; newVal: ' + pa(f) + '; oldVal: ' + pa(g), U[t].push(z));
                                else if (d === c) {
                                  C = !1;
                                  break a;
                                }
                        ...
                        if (!(h = I.$$childHead || I !== this && I.$$nextSibling))
                          for (; I !== this && !(h = I.$$nextSibling);)
                            I = I.$parent;
                      } while (I = h);
                    if ((C || k.length) && !s--)
                      throw p.$$phase = null, a('infdig', b, pa(U));
                  } while (C || k.length);
                ...
                $emit: function (a, b) {
                  var c = [], d, f = this, g = !1, h = {
                      ...
                      defaultPrevented: !1
                    }, k = [h].concat(ua.call(arguments, 1)), m, l;
                  do {
                    d = f.$$listeners[a] || c;
                    h.currentScope = f;
                    m = 0;
                ...
                getTrusted: function (c, d) {
                  ...
                  if (c === ea.RESOURCE_URL) {
                    ...
                    for (n = b.length; l < n; l++)
                      if ('self' === b[l] ? Eb(g) : b[l].exec(g.href)) {
                        p = !0;
                        break;
                      }
                    if (p)
                      for (l = 0, n = a.length; l < n; l++)
                        if ('self' === a[l] ? Eb(g) : a[l].exec(g.href)) {
                          p = !1;
                          break;
                        }
                    if (p)
        ...
        function Dc(b) {
          var a = b.NUMBER_FORMATS;
          return function (b, d) {
            return Fc(b, a.PATTERNS[0], a.GROUP_SEP, a.DECIMAL_SEP, d);
          };
        }
        ...
        function Cc(b) {
          ...
          return function (c, e) {
            ...
            if (!Ka(c))
              return c;
            for (; e;)
              (m = Od.exec(e)) ? (f = f.concat(ua.call(m, 1)), e = f.pop()) : (f.push(e), e = null);
            q(f, function (a) {
              h = Pd[a];
        ...
        function Hc(b, a) {
          ...
          var d = this, e = b.parent().controller('form') || nb, g = 0, f = d.$error = {}, h = [];
        ...
        function pb(b, a, c, d, e, g) {
          ...
          l && ((e = l.match(/^\/(.*)\/([gim]*)$/)) ? (l = RegExp(e[1], e[2]), e = function (a) {
            return oa(d, 'pattern', d.$isEmpty(a) || l.test(a), a);
          }) : e = function (c) {
            var e = b.$eval(l);
            if (!e || !e.test)
              throw t('ngPattern')('noregexp', l, e, fa(a));
            return oa(d, 'pattern', d.$isEmpty(c) || e.test(c), c);
          }, d.$formatters.push(e), d.$parsers.push(e));
          if (c.ngMinlength) {
            var n = V(c.ngMinlength);
            e = function (a) {
              return oa(d, 'minlength', d.$isEmpty(a) || a.length >= n, a);
            };
            d.$parsers.push(e);
            d.$formatters.push(e);
          }
        ...
        var x = function (b) {
          ...
          }, N, z, Ca, ua = [].slice, Qd = [].push, La = Object.prototype.toString, Na = t('ng'), Ba = P.angular || (P.angular = {}), Ua, Ga, ia = [
            '0',
            '0',
            '0'
          ];
        ...
        var Tc = /[A-Z]/g, Rd = {
          ...
          }, Ra = O.cache = {}, db = O.expando = 'ng-' + new Date().getTime(), Xc = 1, Ic = P.document.addEventListener ? function (b, a, c) {
            b.addEventListener(a, c, !1);
          } : function (b, a, c) {
            b.attachEvent('on' + a, c);
          }, zb = P.document.removeEventListener ? function (b, a, c) {
            b.removeEventListener(a, c, !1);
          } : function (b, a, c) {
            b.detachEvent('on' + a, c);
          }, Vc = /([\:\-\_]+(.))/g, Wc = /^moz([A-Z])/, wb = t('jqLite'), Fa = O.prototype = {
            ready: function (b) {
              function a() {
                c || (c = !0, b());
              }
        ...
        q({
          ...
          inheritedData: eb,
          scope: function (b) {
            return z(b).data('$scope') || eb(b.parentNode || b, [
              '$isolateScope',
              '$scope'
            ]);
          },
          ...
          attr: function (b, a, c) {
            ...
            if (fb[d])
              if (D(c))
                ...
                return b[a] || (b.attributes.getNamedItem(a) || E).specified ? d : s;
            else if (D(c))
              b.setAttribute(a, c);
        ...
        q({
          ...
          O.prototype[c] = function (c, e, g) {
            for (var f, h = 0; h < this.length; h++)
              u(f) ? (f = a(this[h], c, e, g), D(f) && (f = z(f))) : xb(f, a(this[h], c, e, g));
            return D(f) ? f : this;
          };
        ...
        var $c = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, ad = /,/, bd = /^\s*(_?)(\S+?)\1\s*$/, Zc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/gm, Ta = t('$injector'), Sd = t('$animate'), Td = [
            '$provide',
            function (a) {
              this.$$selectors = {};
        ...
        var hd = /^(x[\:\-_]|data[\:\-_])/i, oc = t('$interpolate'), Ud = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, sd = {
            http: 80,
            https: 443,
            ftp: 21
          }, Gb = t('$location');
        ...
        Jb.prototype = {
          ...
          readIdent: function () {
            ...
            if (Ja.hasOwnProperty(c))
              ...
              d.fn = y(function (a, c) {
                ...
                assign: function (d, e) {
                  return jb(d, c, e, a.text, a.options);
                }
              });
            }
            this.tokens.push(d);
          ...
          readString: function (a) {
            ...
            for (var d = '', e = a, g = !1; this.index < this.text.length;) {
              ...
              if (g)
                'u' === f ? (f = this.text.substring(this.index + 1, this.index + 5), f.match(/[\da-f]{4}/i) || this.throwError('Invalid unicode escape [\\u' + f + ']'), this.index += 4, d += String.fromCharCode(parseInt(f, 16))) : d = (g = Vd[f]) ? d + g : d + f, g = !1;
              else if ('\\' === f)
                g = !0;
              else {
                if (f === a) {
        ...
        Ya.prototype = {
          ...
          fieldAccess: function (a) {
            ...
            return y(function (c, d, h) {
              return e(h || a(c, d));
            }, {
              assign: function (e, f, h) {
                return jb(a(e, h), d, f, c.text, c.options);
              }
            });
          },
          objectIndex: function (a) {
            ...
            return y(function (e, g) {
              ...
              if (!f)
                return s;
              (f = Xa(f[h], c.text)) && (f.then && c.options.unwrapPromises) && (m = f, '$$v' in f || (m.$$v = s, m.then(function (a) {
                m.$$v = a;
              })), f = f.$$v);
              return f;
            }, {
        ...
        var Ib = {}, ra = t('$sce'), ea = {
            ...
            JS: 'js'
          }, T = R.createElement('a'), zc = xa(P.location.href, !0);
        Ac.$inject = ['$provide'];
        Bc.$inject = ['$locale'];
        Dc.$inject = ['$locale'];
        var Gc = '.', Pd = {
        ...
        var Jc = function (a) {
          ...
          }, Xd = Jc(), Yd = Jc(!0), Zd = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, $d = /^[a-z0-9!#$%&'*+/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i, ae = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Kc = {
            text: pb,
            number: function (a, c, d, e, g, f) {
              ...
              e.$formatters.push(function (a) {
                return oa(e, 'number', e.$isEmpty(a) || rb(a), a);
              });
            },
            url: function (a, c, d, e, g, f) {
              pb(a, c, d, e, g, f);
              a = function (a) {
                return oa(e, 'url', e.$isEmpty(a) || Zd.test(a), a);
              };
              e.$formatters.push(a);
              e.$parsers.push(a);
            },
            email: function (a, c, d, e, g, f) {
              pb(a, c, d, e, g, f);
              a = function (a) {
                return oa(e, 'email', e.$isEmpty(a) || $d.test(a), a);
              };
              e.$formatters.push(a);
              e.$parsers.push(a);
            },
            ...
            function (a, c) {
              return {
                ...
                link: function (d, e, g, f) {
                  f && (Kc[x(g.type)] || Kc.text)(d, e, g, f, c, a);
                }
              };
            }
          ], mb = 'ng-valid', lb = 'ng-invalid', Ia = 'ng-pristine', ob = 'ng-dirty', be = [
            '$scope',
            '$exceptionHandler',
            '$attrs',
            '$element',
            ...
            function (a, c, d, e, g) {
              ...
              if (!m)
                throw t('ngModel')('nonassign', d.ngModel, fa(e));
              this.$render = E;
            ...
            return {
              priority: 100,
              compile: function (a, c) {
                return fe.test(c.ngValue) ? function (a, c, g) {
          ...
          ], ke = Lb('', !0), le = Lb('Odd', 0), me = Lb('Even', 1), ne = sa({
            compile: function (a, c) {
              c.$set('ngCloak', s);
        ...
        var pe = [
                  ...
                  return function (f, h, q, s, A) {
                    ...
                    f.$watch(g.parseAsResourceUrl(m), function (g) {
                      ...
                      g ? (a.get(g, { cache: c }).success(function (a) {
                        ...
                        q === t && K();
                      }), f.$emit('$includeContentRequested')) : (K(), s.template = null);
                    });
                  };
                }
              };
            ...
            function (a, c) {
              ...
              return {
                ...
                link: function (e, g, f) {
                  ...
                  q(f, function (a, c) {
                    s.test(c) && (l[x(c.replace('when', '').replace('Minus', '-'))] = g.attr(f.$attr[c]));
                  });
                  q(l, function (a, e) {
                ...
                link: function (e, g, f, h, m) {
                  ...
                  e.$watchCollection(h, function (a) {
                    ...
                    if (qb(a))
                      ...
                      S = [];
                      for (w in a)
                        a.hasOwnProperty(w) && '$' != w.charAt(0) && S.push(w);
                      S.sort();
                    }
                    y = S.length;
                    h = x.length = S.length;
                    for (f = 0; f < h; f++)
                      if (w = a === S ? f : S[f], u = a[w], u = n(w, u, f), wa(u, '`track by` id'), D.hasOwnProperty(u))
                        E = D[u], delete D[u], v[u] = E, x[f] = E;
                      else {
                    ...
                    for (w in D)
                      D.hasOwnProperty(w) && (E = D[w], f = ub(E.clone), c.leave(f), q(f, function (a) {
                        a.$$NG_REMOVED = !0;
                      }), E.scope.$destroy());
                    f = 0;
            ...
            controller: [
              ...
              function (a, c) {
                if (!c)
                  throw t('ngTransclude')('orphan', fa(a));
                this.$transclude = c;
              }
            ],
            link: function (a, c, d, e) {
          ...
          ], Ee = t('ngOptions'), Fe = Y({ terminal: !0 }), Ge = [
            '$compile',
            '$parse',
            function (a, c) {
              ...
              return {
                ...
                link: function (e, f, h, m) {
                  ...
                  function l(a, c, d) {
                    ...
                    a.$watch(function () {
                      ta(e, d.$viewValue) || (e = $(d.$viewValue), d.$render());
                    });
                    c.on('change', function () {
                      a.$apply(function () {
                        var a = [];
                  ...
                  function n(e, f, g) {
                    function h() {
                      ...
                      if (r)
                        if (w && L(t))
                          for (s = new Sa([]), x = 0; x < t.length; x++)
                            J[m] = t[x], s.put(w(e, J), t[x]);
                        else
                          s = new Sa(t);
                      ...
                      for (C = c.length; J < C; J++) {
                        ...
                        y.length <= J ? (t = {
                          ...
                          label: k.label
                        }, u = [t], y.push(u), f.append(t.element)) : (u = y[J], t = u[0], t.label != d && t.element.attr('label', t.label = d));
                        B = null;
                        x = 0;
                        for (F = k.length; x < F; x++)
                          s = k[x], (d = u[x + 1]) ? (B = d.element, d.label !== s.label && B.text(d.label = s.label), d.id !== s.id && B.val(d.id = s.id), B[0].selected !== s.selected && B.prop('selected', d.selected = s.selected)) : ('' === s.id && A ? H = A : (H = v.clone()).val(s.id).attr('selected', s.selected).text(s.label), u.push({
                            element: H,
                            label: s.label,
                            id: s.id,
                            selected: s.selected
                          }), B ? B.after(H) : t.element.append(H), B = H);
                        for (x++; u.length > x;)
                  ...
                  if (m[1]) {
                    ...
                    h = 0;
                    for (var C = f.children(), x = C.length; h < x; h++)
                      if ('' === C[h].value) {
                        w = A = C.eq(h);
                        break;
                      }
        ...
        (function (a) {
          ...
          try {
            ...
            Ua('ngLocale', []).provider('$locale', rd);
          }
          Ua('ng', ['ngLocale'], [
            '$provide',
            function (a) {
              ...
              a.provider('$compile', ic).directive({
                ...
                ngRequired: Mc,
                ngValue: ge
              }).directive({ ngInclude: re }).directive(Mb).directive(Nc);
              a.provider({
                $anchorScroll: cd,
                $animate: Td,
                $browser: ed,
      ...
      !angular.$$csp() && angular.element(document).find('head').prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide{display:none !important;}ng\\:form{display:block;}</style>');  //# sourceMappingURL=angular.min.js.map
    },
    {}
  ],
  13: [
...
*/
      ...
      module.exports = angular.module(name, []).constant('utils', {
